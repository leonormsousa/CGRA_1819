class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.appearance2.setAmbient(0.3, 0.3, 0.3, 1);
		...
		this.appearance3.setAmbient(0.3, 0.3, 0.3, 1);
		this.appearance3.setDiffuse(0.7, 0.7, 0.7, 1);
		this.appearance3.setSpecular(0.0, 0.0, 0.0, 1);
		this.appearance3.setShininess(120);
		...
		this.appearance2.setTexture(this.texture_water);
		this.appearance2.setTextureWrap('REPEAT', 'REPEAT');
		this.texture_water2 = new CGFtexture(this, "textures/waterMap.jpg");
		this.appearance3.setTexture(this.texture_water2);
		...
		this.testShaders = [
			...
			new CGFshader(this.gl, "shaders/texture1.vert", "shaders/b&w.frag"),
	...
	display() {
		...
		if (this.selectedExampleShader == 11)
		{
		this.texture_water.bind(0);
		this.texture_water2.bind(1);
		}
		this.pushMatrix();

		// bind additional texture to texture unit 
