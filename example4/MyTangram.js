...
class MyTangram extends CGFobject {
	constructor(scene) {
        ...
        this.triangleBig = new MyTriangleBig(scene, true);
        this.triangleBig2 = new MyTriangleBig(scene, false);
        this.triangleSmall = new MyTriangleSmall(scene, true);
        this.triangleSmall2 = new MyTriangleSmall(scene, false);

		//Init Materials
		// Diamond Green
        this.material_diamond = new CGFappearance(scene);
        this.material_diamond.setAmbient(0.1, 0.1, 0.1, 1.0);
        this.material_diamond.setDiffuse(0.8, 0.8, 0.8, 1.0);
